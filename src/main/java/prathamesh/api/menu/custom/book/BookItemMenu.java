...
//	}
    ...
    public Inventory applyBarButtons(Inventory inventory) {
        ////////////////////////////////////////////////////////////////////////////
        Item FILLER1 = new ActionItem(" ", XMaterial.BLACK_STAINED_GLASS_PANE.parseItem());
        ItemStack FILLER = FILLER1.getDisplayIcon();
        for (byte b = 0; b < inventory.getSize(); b++) {
            if (b < 9) {
                inventory.setItem(b, FILLER);
            } else if ((b % 9 == 0) || ((b + 1) % 9 == 0)) {
                inventory.setItem(b, FILLER);
            }
        }
/////////////////////////////////////////////////////////////////////////////////////////////////////
